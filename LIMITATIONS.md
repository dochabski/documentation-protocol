...
The retained DSR Framework pilot is a substantive downstream pilot and self-application case. It supports coherence, structural adequacy, repository usability, source-of-truth discipline, traceability, reviewability, and overclaiming control. It does not prove external adoption, empirical effectiveness, independent semantic adequacy, or automatic downstream artifact validation.

Using this protocol does not relicense downstream artifacts. Downstream artifacts must declare their own licenses, third-party material constraints, metadata, conformance target, validation evidence, release status, and limitations.
